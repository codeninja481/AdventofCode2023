...
even sending you ("the sky") and why your map looks mostly blank ("you sure ask a lot of questions") and 
...
#Calibration = open("Day_One_Trebuchet_Part_1_Test_Input.txt").read().split('\n')
...
print("Calibration answer is: 55386")